...
Representative sequences are saved as Data_Prepration/cluster-results1_cluster.tsv (2,932 sequences) and Data_Prepration/cluster-results2_cluster.tsv (20,615 sequences).
